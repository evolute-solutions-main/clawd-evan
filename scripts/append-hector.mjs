...
const leadName = 'Hector Alfaro'
const fathomUrl = 'https://fathom.video/share/on47jqiHrKpEMT4HFuRAjM1z4-rnxjc5'
const dateUS = '03/04/2026'
...
const existsByUrl = rows.some(r=> (r[urlIdx]||'') === fathomUrl )
...
if (!existsByUrl){
  ...
  row[0] = dateUS
  row[2] = leadName
  row[3] = 'Ads' // Source (from other sheet)
  row[5] = 'Showed'
  row[13] = fathomUrl
  row[15] = nowIso
  row[16] = monthNum
